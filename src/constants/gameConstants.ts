...
export const CAP_CLASSES: Record<CapClass, CapClassStats> = {
  ...
  tank: {
    ...
    restitution: 0.4,
    friction: 0.03,
    frictionAir: 0.018,           // Было 0.015 - увеличено (быстрее тормозит)
    forceMultiplier: 0.0008,      // Было 0.001 - уменьшено (слабее бьёт)
    maxForce: 0.13,               // Было 0.15 - уменьшено
    aimLineLength: 0.7,
    canCurve: false,
    curveStrength: 0,
  },
