...
export const ROLE_BEHAVIORS: Record<UnitRole, RoleBehavior> = {
  goalkeeper: {
    ...
    priorities: {
      defendGoal: 1.0,
      attackGoal: 0.0,
      disruptOpponent: 0.15,
      createChances: 0.0,
      huntOpenGoals: 0.0,
      longShots: 0.0,
    },
    preferredZone: { min: 0.0, max: 0.12 },
    description: 'Stays in goal mouth',
  },
  defender: {
    role: 'defender',
    priorities: {
    ...
    preferredZone: { min: 0.0, max: 0.28 },
    description: 'Defensive third, rarely pushes high',
  },
  disruptor: {
    role: 'disruptor',
    priorities: {
  ...
  opportunist: {
    ...
    preferredZone: { min: 0.65, max: 0.95 },
    description: 'Camps near opponent goal for finishes',
  },
  finisher: {
    role: 'finisher',
    priorities: {
