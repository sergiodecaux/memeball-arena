...
export const UNITS_REPOSITORY: UnitData[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    description:
      'Танк-инициатор магмы. Создаёт разлом, отбрасывающий врагов. [ПАССИВКА] Осада гор: союзники рядом получают +30% массу. [УЛЬТА] Тектонический разлом: конус 45°, отбрасывание врагов.',
    ...
    passive: {
      type: 'aura',
      name: 'Осада гор',
      description: 'Аура: союзники в радиусе 150px получают +30% массу.',
      params: { radius: 150, value: 0.3, target: 'ally' },
    },
  },
  {
    id: 'captain_chronos',
    ...
    description:
      'Тактик киборгов. Улучшает прицел союзников. [ПАССИВКА] Общая сеть: прицел союзников +40%, виден второй отскок. [УЛЬТА] Сфера стазиса: замораживает вражеского юнита на 2 хода.',
    ...
    passive: {
      ...
      params: { radius: 200, value: 0.4, target: 'ally' },
    },
  },
  {
    ...
    description:
      'Защитник пустоты. Гравитация искривляет траектории. [ПАССИВКА] Тёмная гравитация: мяч в радиусе 100px тянется к ближайшему союзнику Void. [УЛЬТА] Коллапс: создаёт сингулярность, притягивающую всех на 2 секунды.',
    ...
    passive: {
      ...
      description: 'Мяч у союзников Void в радиусе 100px слегка притягивается к ним.',
      params: { radius: 100, target: 'ball' },
    },
  },
  {
    id: 'captain_xerxa',
    ...
    description:
      'Лидер роя. Усиливает союзников рядом. [ПАССИВКА] Разум роя: два насекомых ближе 80px — +15% сила. [УЛЬТА] Зов роя: после удара Ксерксы — ещё один ход насекомому при 50% силы.',
    ...
    passive: {
      type: 'aura',
      name: 'Разум роя',
      description: 'Пары насекомых одной команды ближе 80px получают +15% к силе удара.',
      params: { radius: 80, value: 0.15, condition: 'ally_nearby' },
    },
  },
];
